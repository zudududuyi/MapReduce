...
//
//            // 发射学号和成绩
//            context.write(NullWritable.get(), new Text(studentId + "\t" + score));
    ...
    public static class Top100Reducer extends Reducer<NullWritable, Text, NullWritable, Text> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(no2Top100Scores.class);
...
//        FileOutputFormat.setOutputPath(job, new Path(args[1])); // 输出路径
        ...
        FileOutputFormat.setOutputPath(job, new Path("C:\\Users\\13159\\Desktop\\OutPutGrades\\outputC2"));
